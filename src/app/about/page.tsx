  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <Card className="mb-8 animate-fade-in">
        <h2 className="text-2xl font-semibold mb-4 text-[#1D3557]">Background</h2>
      ...
      <Card className="mb-8 animate-fade-in">
        <h2 className="text-2xl font-semibold mb-4 text-[#1D3557]">Skills</h2>
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <h3 className="font-semibold text-lg mb-3 text-[#457B9D]">Data & Analytics</h3>
            <ul className="space-y-2 text-[#1D3557]">
          ...
          <div>
            <h3 className="font-semibold text-lg mb-3 text-[#457B9D]">Business Tools & Systems</h3>
            <ul className="space-y-2 text-[#1D3557]">
              <li className="flex items-center gap-2">
                <span className="w-2 h-2 bg-[#E63946] rounded-full"></span>
      ...
      <Card className="animate-fade-in">
        <h2 className="text-2xl font-semibold mb-4 text-[#1D3557]">Interests & Approach</h2>
        <p className="text-[#1D3557] mb-4">
